            ...
            <div>
                @if ($errors->any())
                    <div class="mb-5" role="alert">
                        <div class="border border-t border-red-400 rounded-t px-4 py-2">
                ...
                <form action="{{ route('users.update', $item->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3 text-right">
                            <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" style="background-color: green">
                                Update User
                            </button>
                        </div>
                    </div>
